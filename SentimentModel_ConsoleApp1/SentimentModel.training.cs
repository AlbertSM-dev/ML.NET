...
namespace SentimentModel_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Alberto\source\repos\ML.NET\ML.NET\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.3182025F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
